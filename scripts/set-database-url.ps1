...
Write-Host ""
Write-Host "1. Open: https://supabase.com/dashboard/project/wfwumugsfylbkailvwvl/settings/database"
...
if ($choice -eq "1") {
    ...
    $url = "postgresql://postgres.wfwumugsfylbkailvwvl:${encoded}@aws-1-ap-south-1.pooler.supabase.com:6543/postgres"
}
...
Write-Host '  cd "e:\Sri Kumaran Silks\HiyoRi-Ecommerce-Nextjs-Supabase"'
