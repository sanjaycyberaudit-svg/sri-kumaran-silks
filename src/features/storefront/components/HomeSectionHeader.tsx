  ...
  return (
    <header className="mb-4 flex min-w-0 flex-col gap-2 sm:mb-5 sm:flex-row sm:items-center sm:justify-between sm:gap-3 md:mb-6">
      <div className="flex min-w-0 items-center gap-2.5 sm:gap-3">
        <span
          aria-hidden
          className="h-6 w-1.5 shrink-0 rounded-full bg-gradient-to-b from-primary to-[#A82020] sm:h-7"
        />
        <h2 className="min-w-0 text-lg font-bold leading-tight tracking-tight sm:text-xl md:text-2xl">
          {title}
          {titleAccent ? (
            <span className="bg-gradient-to-r from-primary to-[#D4A812] bg-clip-text text-transparent">
              {" "}
              {titleAccent}
            </span>
          ) : null}
