...
function CollectionBanner({
  ...
  return (
    <div className="relative mx-auto mb-8 h-[220px] w-full overflow-hidden md:container md:h-[280px]">
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-t from-[#8B1818]/90 via-[#8B1818]/40 to-black/20"
        aria-hidden
      />
      <div className="absolute inset-x-0 bottom-0 p-5 sm:p-8">
        <div className="border-l-[4px] border-[#E8B923] pl-3 sm:pl-4">
