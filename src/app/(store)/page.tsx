...
import { defaultHomeTestimonials } from "@/config/defaultTestimonials";
...
export const metadata: Metadata = {
  title: "SRI KUMARAN SILKS | Premium Silk & Cotton Sarees Online",
  description:
    "Shop authentic silk and cotton sarees at SRI KUMARAN SILKS. Explore featured sarees, wedding collections, Kanjivaram styles, and wholesale sarees from Salem.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: "SRI KUMARAN SILKS | Premium Silk & Cotton Sarees Online",
    description:
      "Shop authentic silk and cotton sarees at SRI KUMARAN SILKS. Explore featured sarees, wedding collections, and wholesale sarees from Salem.",
    url: "/",
  },
};
...
export default async function Home() {
  ...
  const homeTestimonials = data?.homeTestimonials?.edges?.length
    ? data.homeTestimonials.edges
