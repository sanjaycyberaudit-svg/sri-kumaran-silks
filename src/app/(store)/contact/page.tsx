...
export const metadata: Metadata = {
  title: "Contact | SRI KUMARAN SILKS",
  description:
    "Contact SRI KUMARAN SILKS — phone, email, WhatsApp, and store address",
};
...
export default async function ContactPage() {
  ...
  return (
    <InfoPage
      heading="Contact Us"
      description="Reach SRI KUMARAN SILKS by phone, WhatsApp, email, or visit our store in Salem."
    >
