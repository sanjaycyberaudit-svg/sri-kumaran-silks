...
export const metadata: Metadata = {
  title: "Store Policy | SRI KUMARAN SILKS",
  description: "Terms of use and store policies at SRI KUMARAN SILKS",
};
...
export default function StorePolicyPage() {
  return (
    <InfoPage
      ...
      description="Terms that apply when you shop with SRI KUMARAN SILKS online or at our Salem store."
    >
