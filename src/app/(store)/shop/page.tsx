...
export const metadata: Metadata = {
  ...
  description:
    "Browse all silk, cotton, wedding and festive sarees at SRI KUMARAN SILKS. Shop online with secure checkout and delivery across India.",
  alternates: {
    canonical: "/shop",
  },
  openGraph: {
    title: "Shop All Sarees | SRI KUMARAN SILKS",
    description:
      "Browse all silk, cotton, wedding and festive sarees at SRI KUMARAN SILKS.",
    url: "/shop",
  },
};
