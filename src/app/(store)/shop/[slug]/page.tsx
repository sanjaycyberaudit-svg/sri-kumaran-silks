...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (productName) {
    return {
      title: productName,
      description: `Buy ${productName} online from SRI KUMARAN SILKS. Premium silk and cotton sarees with secure checkout.`,
      alternates: {
        canonical: path,
      },
      openGraph: {
        title: `${productName} | SRI KUMARAN SILKS`,
        description: `Buy ${productName} online from SRI KUMARAN SILKS.`,
        url: path,
      },
    };
  }
  ...
  return {
    title: "SRI KUMARAN SILKS | Silk & Cotton Sarees",
