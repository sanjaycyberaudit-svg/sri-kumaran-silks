...
export const metadata: Metadata = {
  title: "Our Story | SRI KUMARAN SILKS",
  description:
    "About SRI KUMARAN SILKS — authentic sarees from Salem, Tamil Nadu",
};
...
export default function AboutPage() {
  return (
    <InfoPage
      heading="Our Story"
      description="SRI KUMARAN SILKS — trusted sarees for every occasion, from our family to yours."
    >
      <p>
        SRI KUMARAN SILKS has been serving customers across Tamil Nadu with
