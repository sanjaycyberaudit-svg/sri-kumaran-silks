...
export const metadata: Metadata = {
  ...
  description:
    "Browse all saree collections at SRI KUMARAN SILKS — Kanjivaram wedding sarees, cotton sarees, soft silk, traditional silk and festive collections.",
  alternates: {
    canonical: "/collections",
  },
  openGraph: {
    title: "All Collections | SRI KUMARAN SILKS",
    description:
      "Browse Kanjivaram, cotton, soft silk, wedding and festive saree collections at SRI KUMARAN SILKS.",
    url: "/collections",
  },
};
