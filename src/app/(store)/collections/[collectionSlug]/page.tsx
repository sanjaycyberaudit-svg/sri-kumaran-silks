...
export function generateMetadata({ params }: CategoryPageProps) {
  ...
  return {
    ...
    description: `Shop ${collectionName} sarees at SRI KUMARAN SILKS. Premium silk and cotton sarees with secure online ordering.`,
    alternates: {
      canonical: path,
    },
    openGraph: {
      title: `${collectionName} Sarees | SRI KUMARAN SILKS`,
      description: `Shop ${collectionName} sarees at SRI KUMARAN SILKS.`,
      url: path,
    },
  };
}
