...
export const metadata: Metadata = {
  title: "FAQ | SRI KUMARAN SILKS",
  description: "Frequently asked questions about SRI KUMARAN SILKS sarees",
};
...
const faqs = [
  ...
  },
  {
    ...
    a: `Yes. We are at ${siteConfig.addressLines.join(", ")}. See our Contact page for phone numbers and WhatsApp.`,
  },
  {
...
export default function FaqPage() {
  return (
    <InfoPage
      heading="FAQ"
      description="Answers to common questions about shopping with SRI KUMARAN SILKS."
    >
