...
function MarqueeItem({ item }: { item: Announcement }) {
  ...
  const content = (
    <>
      <span>{item.text}</span>
      <span
        className="inline-flex items-center gap-0.5 text-[10px] font-bold uppercase tracking-wider sm:text-[11px]"
        ...
        >
          {index > 0 ? (
            <span
              ...
              style={{ color: `${brandColors.goldBorder}B3` }}
              aria-hidden
            >
              ◆
            </span>
...
export function AnnouncementBar() {
  ...
  if (items.length === 1) {
    ...
    return (
      <div
        className="relative overflow-hidden border-b bg-[#A82020]"
        style={{ borderColor: `${brandColors.goldBorder}40` }}
      >
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#6E1212] via-[#A82020] to-[#6E1212]"
          aria-hidden
        />
  ...
  return (
    <div
      className="group/announcement relative overflow-hidden border-b bg-[#A82020]"
      style={{ borderColor: `${brandColors.goldBorder}40` }}
    ...
    >
      ...
      <div className="relative z-10 flex h-[var(--announcement-bar-height)] items-center">
        <div className="relative z-20 flex shrink-0 items-center bg-[#A82020] pl-2 pr-1 sm:pl-3 sm:pr-2">
          <Sparkles
